...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row gap-12">
        ...
        <div class="w-full md:w-1/3 flex flex-col items-center text-center">
            ...
            <form id="avatar-form" action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data" class="relative group">
                @csrf

                <input type="file" name="avatar" id="avatar-input" accept="image/*" class="hidden"
                    onchange="document.getElementById('avatar-form').submit()" />

                <div class="w-48 h-48 rounded-full p-1 bg-gradient-to-tr from-primary to-secondary-container editorial-shadow">
            ...
            <div class="mt-6">
                <p class="text-sm font-bold text-primary uppercase tracking-widest mb-1">
                    Thành viên Premium
                </p>
                <button type="button"
                    onclick="document.getElementById('avatar-input').click()"
        ...
        <div class="w-full md:w-2/3">
            ...
            <header class="mb-12">
                ...
                <p class="text-on-surface-variant leading-[1.7] max-w-lg">
                    Cập nhật thông tin chi tiết để các nhà tuyển dụng hàng đầu có thể tìm thấy bạn dễ dàng hơn.
                </p>
            </header>
                        ...
                        <select name="industry"
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->name }}"
                                    {{ old('industry', $user->industry) == $category->name ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input name="experience"
                            ...
                            placeholder="VD: 2 năm Laravel / React" />
                    </div>
